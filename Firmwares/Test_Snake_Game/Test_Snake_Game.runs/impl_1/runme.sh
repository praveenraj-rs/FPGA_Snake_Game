...
HD_PWD='C:/Users/prave/Desktop/FPGA_Baysys3_Snake_Game/Firmwares/Test_Snake_Game/Test_Snake_Game.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log snake_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source snake_wrapper.tcl -notrace
