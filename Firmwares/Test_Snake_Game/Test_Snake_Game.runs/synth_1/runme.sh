...
HD_PWD='C:/Users/prave/Desktop/FPGA_Baysys3_Snake_Game/Firmwares/Test_Snake_Game/Test_Snake_Game.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log snake_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source snake_wrapper.tcl
